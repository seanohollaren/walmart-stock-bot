...
(async () => {
  const res = await fetch("https://www.walmart.com/terra-firma/fetch?rgs=REVIEWS_FIELD,QUESTIONS_FIELD,CARE_PLANS_MAP,HOME_SERVICES_MAP,BUY_BOX_PRODUCT_IDML,CHECKOUT_COMMENTS_FIELD", {
    ...
    "body": "{\"itemId\":\"14660327\",\"categoryPathId\":\"0:4125:4134:1026285:1078284:1078285\",\"paginationContext\":{\"selected\":false,\"selectedCatalogSellerId\":null},\"postalAddress\":{\"postalCode\":\"97209\",\"zipLocated\":true,\"stateOrProvinceCode\":\"OR\",\"countryCode\":\"USA\",\"addressType\":\"RESIDENTIAL\"},\"storeFrontIds\":[{\"usStoreId\":\"5899\",\"preferred\":false,\"semStore\":false,\"lastPickupStore\":false,\"distance\":4.78},{\"usStoreId\":\"2552\",\"preferred\":false,\"semStore\":false,\"lastPickupStore\":false,\"distance\":6},{\"usStoreId\":\"5935\",\"preferred\":false,\"semStore\":false,\"lastPickupStore\":false,\"distance\":7.33},{\"usStoreId\":\"5440\",\"preferred\":false,\"semStore\":false,\"lastPickupStore\":false,\"distance\":7.58},{\"usStoreId\":\"3145\",\"preferred\":false,\"semStore\":false,\"lastPickupStore\":false,\"distance\":7.91}]}",
    "method": "POST",
    "mode": "cors"
  }).then(data => data.json());

  console.log(res.payload.buyBox.athenaAvailabilityStatus);
})();
